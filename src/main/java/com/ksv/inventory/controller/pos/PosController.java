...
import static com.ksv.inventory.interfaces.ProductInterface.PRODUCTLIST;
...
import com.ksv.inventory.interfaces.ProductInterface;
...
public class PosController implements Initializable, ProductInterface {
    ...
    @FXML
    private TextField subTotalField, discountField, vatField, netPayableField, name;
    @FXML
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        /*name.setText("abc");
        Employee employee = new Employee(name.getText().trim()); // get first name
        employee = new Employee();
        String fname = employee.getFirstName().trim();*/
        loadData();
...
//        dueColumn.setCellValueFactory(new PropertyValueFactory<>("due"));
    ...
    public void addAction(ActionEvent event) {
        ...
        if (validateInput()) {
            ...
            ITEMLIST.add(new Item(productName, unitPrice, quantity,total)); // insert into table 
            calculation();
            resetAdd();
            productTableView.getSelectionModel().clearSelection();
        }
    ...
    public void paymentAction(ActionEvent event) throws Exception {
    	System.out.println(" paymentAction from PosController .... when payment btn press...");
        ...
        for(Item itm : sold) {
        	System.out.println("posController section : "+itm.toString());
        }

        FXMLLoader loader = new FXMLLoader((getClass().getResource("/fxml/Invoice.fxml")));
        InvoiceController controller = new InvoiceController();
        loader.setController(controller);
        controller.setData(Double.parseDouble(netPayableField.getText().trim()), sold, payment); //remove employee
