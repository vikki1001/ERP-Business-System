package com.ksv.inventory.controller.supplier;
...
import com.ksv.inventory.interfaces.SupplierInterface;
import com.ksv.inventory.model.SupplierModel;
...
//            Supplier selectedSupplier = supplierTable.getSelectionModel().getSelectedItem();
        	...
        	ObservableList<Supplier> selectedProduct = supplierTable.getSelectionModel().getSelectedItems();
        	for(Supplier item : selectedProduct) {
        		model.deleteSuplier(item);
