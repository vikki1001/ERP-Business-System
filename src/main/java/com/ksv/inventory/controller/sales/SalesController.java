package com.ksv.inventory.controller.sales;
...
import com.ksv.inventory.interfaces.SaleInterface;
...
public class SalesController implements Initializable, SaleInterface {
    ...
    public void deleteAction(ActionEvent event) throws Exception {
        ...
        if (result.get() == ButtonType.OK) {
        	...
        	ObservableList<Sale> selectedProduct = salesTable.getSelectionModel().getSelectedItems();
        	for(Sale item : selectedProduct) {
        		model.deleteSale(item);
