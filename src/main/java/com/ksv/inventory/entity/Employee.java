...
public class Employee implements Serializable {
    ...
    public Employee(String firstName) { /* constructor for firstname in employee. */
        this.firstName = firstName;
    }


	public Employee(String firstName, String lastName,String email, String userName, String password, String phone, String address) {
        this.firstName = firstName;
